...
volatile unsigned char railCrossingT;
volatile unsigned char readTrack1T;
volatile unsigned char readTrack2T;
volatile unsigned char blinkT;
volatile unsigned char servoT;
...
if(!(_100ms % 10)) { _100ms = 0;
	...
	if(readTrack1T) readTrack1T--;
	if(readTrack2T) readTrack2T--;
